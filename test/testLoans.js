...
// Import test data
const { alice, bob, charlie, emptyName, emptyUsername, emptyEmail, emptyPassword, invalidEmail, invalidPassword, invalidName, invalidUsername } = require('./data');
    ...
    it('alice sends a loan request with missing username - FAILS', done => {
        server
            ...
            .end((err, res) => {
                ...
                res.body.should.be.equal('Missing field(s): user and amount required');
                res.body.should.be.a('string');
                done();
            });
    });
    ...
    it('bob trys to accept his own loan request - FAILS', done => {
        server
            ...
            .end((err, res) => {
                res.should.have.status(400);
                res.body.should.be.a('string');
                res.body.should.be.equal('You cannot confirm a loan you created');
                done();
            });
    });
    ...
    it('Alice trys to reject a loan that bob send to charlie - FAILS', done => {
        server
            ...
            .end((err, res) => {
                ...
                res.body.should.be.a('string');
                res.body.should.be.equal('You can not access other peoples loans');
                done();
            });
    });
